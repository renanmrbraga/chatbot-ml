...
interface ComparativeImageProps {
  imageBase64?: string | null;
}

const ComparativeImage: React.FC<ComparativeImageProps> = ({ imageBase64 }) => {
...
export default ComparativeImage;
